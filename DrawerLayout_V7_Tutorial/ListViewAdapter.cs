...
namespace MyFirstProject
{
    ...
    public class ListViewAdapter:BaseAdapter
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
			...
			var txtName = view.FindViewById<TextView>(Resource.Id.textView11);
            var txtAge = view.FindViewById<TextView>(Resource.Id.textView12);
			var txtEmail = view.FindViewById<TextView>(Resource.Id.textView13);
